...
Tests dobby/basic and dobby/power models with the configured MAIN_LLM provider.
"""
...
async def main():
    ...
    print("\n[dobby/basic]")
    basic_model = print_model_info("dobby/basic")
    
    print("\n[dobby/power]")
    power_model = print_model_info("dobby/power")
    
    print("\n[dobby/grok-4-1-fast]")
    grok_model = print_model_info("dobby/grok-4-1-fast")
    ...
    print("\n[Testing dobby/basic]")
    basic_ok = await test_llm_call("dobby/basic")
    
    print("\n[Testing dobby/power]")
    power_ok = await test_llm_call("dobby/power")
    ...
    print("Summary")
    print("=" * 60)
    print(f"  dobby/basic:  {'✓ PASS' if basic_ok else '❌ FAIL'}")
    print(f"  dobby/power:  {'✓ PASS' if power_ok else '❌ FAIL'}")
    print()
