# Dobby Agent Evaluations

Evaluate Dobby agent performance using **Braintrust** with JSON-based test cases.
...
Results are automatically uploaded to: https://www.braintrust.dev/app/Dobby/p/Dobby%20Agent/experiments/
...
| `EVAL_MODEL` | Override model for evals (default: `dobby/basic`) |
