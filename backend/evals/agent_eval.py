...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Run Dobby Agent evaluations",
...
Examples:
    ...
    parser.add_argument(
        "-m", "--model",
        type=str,
        default=os.getenv("EVAL_MODEL", "dobby/basic"),
        help="Model to use (default: dobby/basic)"
    )
...
""")
    ...
    # Run evaluation
    Eval(
        "Dobby Agent",  # Project name in Braintrust
        data=get_eval_data,
