...
class Configuration:
    ...
    MEMORY_EXTRACTION_MODEL: Optional[str] = "dobby/basic"
    ...
    SANDBOX_IMAGE_NAME = "dobby/suna:0.1.3.30"
    SANDBOX_SNAPSHOT_NAME = "dobby/suna:0.1.3.30"
    ...
    def _generate_admin_api_key(self) -> str:
        """Generate a secure admin API key for Dobby administrative functions."""
    ...
    def __init__(self):
        ...
        if not self.DOBBY_ADMIN_API_KEY:
            self.DOBBY_ADMIN_API_KEY = self._generate_admin_api_key()
            logger.info("Auto-generated DOBBY_ADMIN_API_KEY for administrative functions")
