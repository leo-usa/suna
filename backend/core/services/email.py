...
class EmailService:
    ...
    def send_welcome_email(self, user_email: str, user_name: Optional[str] = None) -> bool:
        ...
        subject = "🎉 Welcome to Dobby — Let's Get Started "
    ...
    def send_referral_email(
        ...
        try:
            ...
            mail = mt.Mail(
                sender=mt.Address(email=sender_email_to_use, name='Dobby'),
...
<body>
  <div class="container">
    <div class="logo-container">
      <img src="https://heprlhlltebrxydgtsjs.supabase.co/storage/v1/object/public/image-uploads/loaded_images/Profile%20Picture%20Black.png" alt="Dobby Logo" class="logo">
    </div>
    ...
    <p>Thanks again, and welcome to the Dobby community!</p>
  </div>
</body>
</html>"""
...
Thanks again, and welcome to the Dobby community!

---
© 2025 Dobby. All rights reserved.
You received this email because you signed up for a Dobby account."""
...
© Dobby. All rights reserved."""
    ...
    def send_otp_email(self, user_email: str, otp_code: str) -> bool:
        ...
        subject = "Your Dobby verification code"
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #fafafa; color: #1a1a1a;">
  <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 520px; margin: 0 auto; padding: 40px 20px;">
    ...
    def _get_otp_email_text(self, otp_code: str) -> str:
        return f"""Your Dobby verification code
