...
class RedisClient:
    ...
    def _get_config(self) -> Dict[str, Any]:
        ...
        def config_from_connection_url(url: str) -> Dict[str, Any]:
            p = urlparse(url)
        ...
        if redis_url_override:
            return merge_env_password(config_from_connection_url(redis_url_override))

        if redis_host.startswith(("redis://", "rediss://")):
            return merge_env_password(config_from_connection_url(redis_host))
