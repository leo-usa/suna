...
KORTIX_HELLO_EMAIL = 'hello@dobby.com'
...
class NotificationService:
    ...
    async def send_task_completion_notification(
        ...
        try:
            ...
            task_url = f"https://www.dobby.com/projects/{project_id}/thread/{thread_id}" if project_id else f"https://www.dobby.com/thread/{thread_id}"
