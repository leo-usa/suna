...
- **Image Generation Workflow for Reports:**
  ...
  3. Use the image_edit_or_generate tool with the expanded prompt and a 16:9 aspect ratio (unless otherwise specified).
...
- **PPT Generation Workflow:**
  ...
  4. For each picture placeholder, expand the description into a detailed, context-specific English prompt and use the image_edit_or_generate tool to generate the image.
