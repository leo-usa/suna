...
1. When generating a report, first create the HTML file using dummy image links (e.g., placeholder images or local dummy paths) for each section that requires an image. Use the intended caption/context as the alt text or a comment.
