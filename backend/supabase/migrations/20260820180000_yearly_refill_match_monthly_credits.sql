-- Yearly refill cron was hardcoded to 2x monthly credits (Plus 40, Pro 100, Ultra 400).
-- Align it with backend/core/billing/shared/config.py monthly_credits.
...
COMMENT ON FUNCTION process_monthly_refills IS 'Processes monthly credit refills for yearly subscribers including prepaid annual (Alipay/WeChat) plans. Amounts match TIERS.monthly_credits.';
