...
export const TOOL_COMPLETED_NAMES: ReadonlyMap<string, string> = new Map([
  ...
  ['computer-screenshot', 'Captured Screen'],
  ['computer_screenshot', 'Captured Screen'],
  ['computer-click', 'Clicked'],
  ['computer_click', 'Clicked'],
  ['computer-type', 'Typed'],
  ['computer_type', 'Typed'],
  ['computer-key', 'Pressed Key'],
  ['computer_key', 'Pressed Key'],
  ['computer-scroll', 'Scrolled'],
  ['computer_scroll', 'Scrolled'],
  ['computer-open', 'Opened'],
  ['computer_open', 'Opened'],
]);
