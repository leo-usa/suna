...
interface DobbyComputerHeaderProps {
...
/**
 * Shared header component for all Dobby Computer views (Files, File Viewer, Browser).
 ...
 */
export function DobbyComputerHeader({
  icon: Icon,
  onIconClick,
  iconTitle,
  title,
