...
/**
 * DobbyLoader - A unified circular loading animation component
 * 
 ...
 * <DobbyLoader variant="white" />
 * 
 * // Always black (for light backgrounds in any theme)
 * <DobbyLoader variant="black" />
 * 
 * // Custom size
      ...
      <div
        style={{
          ...
          animation: autoPlay && loop 
            ? `dobby-spin ${animationDuration}s linear infinite` 
            : autoPlay 
              ? `dobby-spin ${animationDuration}s linear` 
              : 'none',
        }}
      />
      <style jsx>{`
