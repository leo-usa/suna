...
export const DESKTOP_DOWNLOAD_LINKS = {
  windows:
    'https://tsdrmlnyclxwkryqrjic.supabase.co/storage/v1/object/public/Desktop%20App/Dobby%20Setup%202.0.3.exe',
  /** Apple Silicon (M1/M2/M3) */
  macArm:
    'https://tsdrmlnyclxwkryqrjic.supabase.co/storage/v1/object/public/Desktop%20App/Dobby-2.0.3-arm64.dmg',
