...
const DobbyLoader = lazy(() => import('@/components/ui/dobby-loader').then(mod => ({ default: mod.DobbyLoader })));
                ...
                <CardContent className="p-6 h-full">
                  <div className="flex items-center justify-between h-full">
                    ...
                    <div className="h-12 w-12 flex items-center justify-center">
                      <Suspense fallback={<DobbyLoader size="small" />}>
                        <DobbyLoader size="small" customSize={24} />
                      </Suspense>
                    </div>
                  </div>
                </CardContent>
