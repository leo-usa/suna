...
export const viewport: Viewport = {
  themeColor: [
    { media: '(prefers-color-scheme: light)', color: '#8c1515' },
...
export const metadata: Metadata = {
  ...
  authors: [{ name: 'Dobby Team', url: 'https://www.dobby.com' }],
  creator: 'Dobby Team',
  ...
  return (
    <html lang="en" suppressHydrationWarning className={`${roobert.variable} ${roobertMono.variable}`}>
      <head>
        ...
        <meta property="og:image" content="https://dobby.com/banner.png" />
        <meta property="og:url" content="https://dobby.com" />
        ...
        <meta name="twitter:image" content="https://dobby.com/banner.png" />
        <meta name="twitter:site" content="@dobby" />
        <link rel="canonical" href="https://dobby.com" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              alternateName: ['Dobby', 'Dobby AI', 'Dobby: Your Autonomous AI Worker'],
              url: siteMetadata.url,
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              alternateName: [siteMetadata.name, 'Dobby'],
