                  ...
                  {activeTab === 'imprint' ? (
                    ...
                    <div>
                      ...
                      <ul className="text-muted-foreground space-y-1 mb-6">
                        ...
                        <li>
                          "Service" refers to the Dobby platform and all related
                      ...
                      <p className="text-muted-foreground text-balance mb-4">
                        Dobby is a complete platform for creating, managing, and
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        GitHub repository. Self-hosting is governed by the Dobby Public
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        All Dobby logos, marks, and designations are trademarks or
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        LIMITATION, THE Dobby WEB APP AND ANY CONTENT) IS PROVIDED
                        ...
                        Dobby DOES NOT GUARANTEE THE ACCURACY, COMPLETENESS, OR
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        References to our "Services" at Dobby in this statement
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        Dobby does not collect biometric or identifying
