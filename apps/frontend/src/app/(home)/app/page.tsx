...
function DobbySymbol({ size = 24, className }: { size?: number; className?: string }) {
  return (
    <svg 
      width={size} 
      height={size} 
          ...
          >
            ...
            <div className="relative mb-6 z-10">
              <div className="relative w-20 h-20 bg-foreground rounded-[20px] flex items-center justify-center">
                <DobbySymbol size={40} className="text-background" />
              </div>
            </div>
            ...
            <p className="text-base text-muted-foreground text-center max-w-xl leading-relaxed">
              ...
              Download the app and take Dobby with you everywhere.
            </p>
          </motion.div>
