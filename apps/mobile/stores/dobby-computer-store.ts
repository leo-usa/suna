...
export const useDobbyComputerStore = create<DobbyComputerState>((set, get) => ({
  ...initialState,
...
export const useDobbyComputerIsOpen = () =>
  useDobbyComputerStore((state) => state.isOpen);
...
export const useDobbyComputerSelectedVersion = () =>
  useDobbyComputerStore((state) => state.selectedVersion);

export const useDobbyComputerSelectedVersionDate = () =>
  useDobbyComputerStore((state) => state.selectedVersionDate);

export const useDobbyComputerVersionActions = () =>
