...
export const metadata: Metadata = {
  ...
  description: "Dobby is a fully open source AI assistant that helps you accomplish real-world tasks with ease. Through natural conversation, Dobby becomes your digital companion for research, data analysis, and everyday challenges.",
  ...
  openGraph: {
    ...
    description: "Dobby is a fully open source AI assistant that helps you accomplish real-world tasks with ease through natural conversation.",
    url: siteConfig.url,
    siteName: "Dobby",
    images: [{
      url: "/banner.png",
