          ...
          <div className="rounded-xl bg-[#F3F4F6] dark:bg-[#F9FAFB]/[0.02] border border-border p-6">
            <div className="flex flex-col gap-6">
              <div className="flex items-center gap-2 text-primary font-medium">
                ...
                <span>{t('openSource.repo')}</span>
              </div>
              <div className="relative">
                <h3 className="text-2xl font-semibold tracking-tight">
                  {t('openSource.mainTitle')}
                </h3>
                <p className="text-muted-foreground mt-2">
                  {t('openSource.mainDesc')}
                </p>
              </div>
              ...
              <Link 
                href="https://github.com/leo-usa/suna" 
                target="_blank" 
          ...
          <div className="rounded-xl bg-[#F3F4F6] dark:bg-[#F9FAFB]/[0.02] border border-border p-6">
            <div className="flex flex-col gap-6">
              <h3 className="text-xl md:text-2xl font-medium tracking-tight">
                {t('openSource.transparencyTitle')}
              </h3>
              <p className="text-muted-foreground">
                {t('openSource.transparencyDesc')}
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-medium">{t('openSource.transparency')}</h4>
                    <p className="text-muted-foreground text-sm">{t('openSource.transparencySub')}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="rounded-full bg-secondary/10 p-2 mt-0.5">
                  ...
                  <div>
                    <h4 className="font-medium">{t('openSource.community')}</h4>
                    <p className="text-muted-foreground text-sm">{t('openSource.communitySub')}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="rounded-full bg-secondary/10 p-2 mt-0.5">
                  ...
                  <div>
                    <h4 className="font-medium">{t('openSource.license')}</h4>
                    <p className="text-muted-foreground text-sm">{t('openSource.licenseSub')}</p>
                  </div>
                </div>
              </div>
            </div>
