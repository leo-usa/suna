  ...
  auth: {
    ...
    passwordUpdated: '密码已成功更新',
      ...
      billing: {
        ...
        usageLimitReached: '使用限制已達',
        dismiss: '關閉',
        upgradePlan: '升級方案',
        upgradeRequired: '需要升級',
        upgradeRequiredDescription: '您已達到計劃的使用限制。升級以繼續享受我們的優質功能。',
        planExhaustedMessage: '您當前的計劃在此計費期間已用完。',
        monthlyUsageLimitReached: '本月使用限制已達，請升級。',
