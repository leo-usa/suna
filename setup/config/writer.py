...
class ConfigWriter:
    ...
    def write_backend_env(self, config: SetupConfig) -> Tuple[bool, str]:
        ...
        env_vars = {
            ...
            # Dobby
            "DOBBY_ADMIN_API_KEY": config.dobby.DOBBY_ADMIN_API_KEY,
            # VAPI
        ...
        header = f"Generated by Dobby Suna setup for '{setup_method}' setup"
    ...
    def write_frontend_env(self, config: SetupConfig) -> Tuple[bool, str]:
        ...
        header = "Generated by Dobby Suna setup"
        content = self._format_env_content(env_vars, header)
